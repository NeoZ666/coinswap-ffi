...
- `Sources/CoinswapFFI/include/CoinswapFFI.h` and `module.modulemap` - C headers
- `Sources/CoinswapFFI/libcoinswap_ffi.dylib` - native dylib (for local dev usage)
...
- Swift 5.7+
- Xcode 14+
- Bitcoin Core RPC + Tor for live tests
