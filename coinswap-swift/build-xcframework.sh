...
IPHONEOS_DEPLOYMENT_TARGET=14.0 cargo build --package coinswap-ffi --profile release-smaller --target x86_64-apple-darwin
IPHONEOS_DEPLOYMENT_TARGET=14.0 cargo build --package coinswap-ffi --profile release-smaller --target aarch64-apple-darwin
