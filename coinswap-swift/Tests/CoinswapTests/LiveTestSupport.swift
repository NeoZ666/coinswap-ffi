...
struct LiveTestConfig {
    ...
    init(walletNameOverride: String? = nil) throws {
        ...
        self.rpcConfig = RpcConfig(url: "localhost:18442", username: "user", password: "password", walletName: walletName)
...
func requireLiveTestsEnabled() throws {
    ...
    if disabled {
        throw XCTSkip("Set COINSWAP_LIVE_TESTS=1 to enable live tests")
    }
}
